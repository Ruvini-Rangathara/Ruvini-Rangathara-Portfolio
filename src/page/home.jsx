...
const Home = () => {
    ...
    return (
        <div id={'home_id'}
             className="w-[90vw] xs:h-[100vh] xs:w-[88vw] mx-auto bg-white rounded-lg overflow-hidden xl:mt-14 xs:mt-6 ">
            <div
                className=" xs:my-10 xl:my-0 bg-gradient-to-r from-blue-100 via-purple-100 to-pink-100 px-0 xs:px-4 xl:h-[80vh] xs:h-[75vh] w-full text-center flex justify-center rounded-lg">
