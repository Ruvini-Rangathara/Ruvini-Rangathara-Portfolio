...
const ProjectModal = ({ isOpen, onClose, project }) => {
    ...
    return (
        <div onClick={onClose} className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center z-10">
            <div className="bg-white p-6 rounded-md shadow-md max-w-lg w-full">
                <img src={mainImage} alt="project" className="w-full h-64 object-cover rounded-lg mb-4" />
...
const Project = () => {
    return (
        <div className="px-24 mx-auto mt-10">
