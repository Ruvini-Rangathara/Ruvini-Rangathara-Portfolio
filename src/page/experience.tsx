        ...
        <div className={'flex xl:flex-row xs:flex-col px-32'}>
            <div className="max-w-4xl mx-auto">
                <div className={'flex'}>
                    ...
                    <h2 className="ml-2 text-[16px] font-bold mb-8">Experience</h2>
                </div>
                <div className="relative border-l-2 border-gray-400">
                    {experiences.map((experience, index) => (
                        <div key={index} className="mb-8 ml-4">
                            ...
                            <p className="text-[12px] text-gray-600">{experience.date}</p>
                            <h3 className="text-[12px] font-semibold">{experience.title}</h3>
                            <p className="text-[12px] text-gray-700">{experience.description}</p>
                        </div>
                    ))}
                </div>
            </div>
            ...
            <div className="max-w-4xl mx-auto">
                <div className={'flex'}>
                    ...
                    <h2 className="ml-2 text-[16px] font-bold mb-8">Education</h2>
                </div>
                <div className="relative border-l-2 border-gray-400">
